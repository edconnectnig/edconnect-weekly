...
assert(users.delete(jerry.id) === true);
assert(users.getById(jerry.id) === null, `deleted user should no longer be avaiable in the data array. The getById method should now return null for the specified id`)
