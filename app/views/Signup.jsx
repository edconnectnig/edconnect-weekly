    ...
    return (
        <>
            ...
            <Layout user={user}>
                ...
                <div id="error"> {errors?.length > 0 ? <Alert variant="danger" id="error" style={{ marginLeft: '120px', marginRight: '120px' }}>{errors.map((error) =><span key={error}>{error} <br /></span>)}</Alert> : null} </div>
